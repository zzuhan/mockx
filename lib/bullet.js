...
// 这之后，可插件化，加入一些其他的东西
MockBullet.prototype.callback = function (err, targetPath, charset, data, statusCode, headers) {
  var _this = this;
...
MockBullet.prototype.handleByRemote = function(){
  ...
  var proxyReq = http.request(options, function (proxyRes) {
    ...
    proxyRes.on('end', function () {
      ...
      parseJSONorJSONP(body, function (jsonData) {
        _this.callback(null, 'xxx', charset, jsonData, proxyRes.statusCode, proxyRes.headers);
      }, req.query[config.jsonp]);
    })
  });
